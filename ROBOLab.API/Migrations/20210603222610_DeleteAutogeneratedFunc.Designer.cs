...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20210603222610_DeleteAutogeneratedFunc")]
    partial class DeleteAutogeneratedFunc
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 26, 9, 791, DateTimeKind.Local).AddTicks(8352),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1
                        },
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 26, 9, 794, DateTimeKind.Local).AddTicks(3781),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2
                        });
