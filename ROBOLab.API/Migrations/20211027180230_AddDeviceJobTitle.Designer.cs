...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20211027180230_AddDeviceJobTitle")]
    partial class AddDeviceJobTitle
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 10, 27, 20, 2, 30, 180, DateTimeKind.Local).AddTicks(4826),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1,
                            Status = 0,
                        ...
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 10, 27, 20, 2, 30, 183, DateTimeKind.Local).AddTicks(235),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2,
                            Status = 0,
                        ...
                        new
                        {
                            Id = 3,
                            Body = "",
                            CreatedDate = new DateTime(2021, 10, 27, 20, 2, 30, 183, DateTimeKind.Local).AddTicks(264),
                            DeviceId = 100,
                            Done = false,
                            JobId = 100,
                            Status = 0,
                        ...
                        new
                        {
                            Id = 4,
                            Body = "",
                            CreatedDate = new DateTime(2021, 10, 27, 20, 2, 30, 183, DateTimeKind.Local).AddTicks(269),
                            DeviceId = 120,
                            Done = false,
                            JobId = 120,
                            Status = 0,
                        ...
                        new
                        {
                            Id = 5,
                            Body = "",
                            CreatedDate = new DateTime(2021, 10, 27, 20, 2, 30, 183, DateTimeKind.Local).AddTicks(272),
                            DeviceId = 120,
                            Done = false,
                            JobId = 121,
                            Status = 0,
