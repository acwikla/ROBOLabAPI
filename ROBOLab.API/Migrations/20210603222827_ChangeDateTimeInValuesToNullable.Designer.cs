...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20210603222827_ChangeDateTimeInValuesToNullable")]
    partial class ChangeDateTimeInValuesToNullable
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 28, 26, 55, DateTimeKind.Local).AddTicks(2596),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1
                        },
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 28, 26, 59, DateTimeKind.Local).AddTicks(4526),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2
                        });
