...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20210603222323_UpdateAutogeneratedDateTime")]
    partial class UpdateAutogeneratedDateTime
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 23, 22, 845, DateTimeKind.Local).AddTicks(7559),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1
                        },
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 23, 22, 849, DateTimeKind.Local).AddTicks(8006),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2
                        });
