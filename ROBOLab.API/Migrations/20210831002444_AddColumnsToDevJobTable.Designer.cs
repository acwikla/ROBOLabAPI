...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20210831002444_AddColumnsToDevJobTable")]
    partial class AddColumnsToDevJobTable
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 8, 31, 2, 24, 43, 545, DateTimeKind.Local).AddTicks(9245),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1
                        },
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 8, 31, 2, 24, 43, 548, DateTimeKind.Local).AddTicks(2916),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2
                        },
                        new
                        {
                            Id = 3,
                            Body = "",
                            CreatedDate = new DateTime(2021, 8, 31, 2, 24, 43, 548, DateTimeKind.Local).AddTicks(2953),
                            DeviceId = 100,
                            Done = false,
                            JobId = 100
                        },
                        new
                        {
                            Id = 4,
                            Body = "",
                            CreatedDate = new DateTime(2021, 8, 31, 2, 24, 43, 548, DateTimeKind.Local).AddTicks(2958),
                            DeviceId = 120,
                            Done = false,
                            JobId = 120
                        },
                        new
                        {
                            Id = 5,
                            Body = "",
                            CreatedDate = new DateTime(2021, 8, 31, 2, 24, 43, 548, DateTimeKind.Local).AddTicks(2961),
                            DeviceId = 120,
                            Done = false,
                            JobId = 121
                        });
