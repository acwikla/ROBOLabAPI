...
namespace ROBOLab.API.Migrations
{
    ...
    [Migration("20210603222008_AddAutoGeneratedDateTimeInValueModel")]
    partial class AddAutoGeneratedDateTimeInValueModel
    {
            ...
            modelBuilder.Entity("ROBOLab.Core.Models.DeviceJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Body = "#FF6611",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 20, 7, 294, DateTimeKind.Local).AddTicks(5035),
                            DeviceId = 1,
                            Done = false,
                            JobId = 1
                        },
                        new
                        {
                            Id = 2,
                            Body = "",
                            CreatedDate = new DateTime(2021, 6, 4, 0, 20, 7, 298, DateTimeKind.Local).AddTicks(6167),
                            DeviceId = 1,
                            Done = false,
                            JobId = 2
                        });
